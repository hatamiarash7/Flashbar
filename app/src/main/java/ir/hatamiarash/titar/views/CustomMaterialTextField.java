...
package ir.hatamiarash.titar.views;
...
public class CustomMaterialTextField extends FrameLayout {
	...
	public CustomMaterialTextField(Context context) {
		super(context);
		init();
	}
	
	public CustomMaterialTextField(Context context, AttributeSet attrs) {
		super(context, attrs);
		handleAttributes(context, attrs);
		init();
	}
	
	public CustomMaterialTextField(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	protected void handleAttributes(Context context, AttributeSet attrs) {
		try {
			TypedArray styledAttrs = context.obtainStyledAttributes(attrs, R.styleable.CustomMaterialTextField);
			...
			{
				hasFocus = styledAttrs.getBoolean(com.github.florent37.materialtextfield.R.styleable.MaterialTextField_mtf_hasFocus, false);
			}
			{
				backgroundColor = styledAttrs.getColor(com.github.florent37.materialtextfield.R.styleable.MaterialTextField_mtf_backgroundColor, -1);
			}
	...
	protected void onFinishInflate() {
		...
		addView(LayoutInflater.from(getContext()).inflate(R.layout.custom_mtf_layout, this, false));
		
		editTextLayout = findViewById(com.github.florent37.materialtextfield.R.id.mtf_editTextLayout);
		removeView(editText);
		editTextLayout.addView(editText);
		
		label = findViewById(com.github.florent37.materialtextfield.R.id.mtf_label);
		...
		image = findViewById(com.github.florent37.materialtextfield.R.id.mtf_image);
